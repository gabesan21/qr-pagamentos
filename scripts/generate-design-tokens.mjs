...
const THEME_PROJECTION = {
  ...
  "color-feedback-info": "color.feedback.info", "color-feedback-info-soft": "color.feedback.info.soft", "color-feedback-info-foreground": "color.feedback.info.foreground", "color-feedback-info-soft-foreground": "color.feedback.info.soft-foreground",
