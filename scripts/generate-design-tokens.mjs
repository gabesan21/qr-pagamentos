...
const COMMON_PROJECTION = {
  ...
  "type-body": "type.primitive.size.body", "type-small": "type.primitive.size.caption", "type-label": "type.primitive.size.label",
  "type-compact-heading": "type.primitive.size.compact-heading", "type-title": "type.primitive.size.section-heading", "type-display": "type.primitive.size.page-heading",
...
const THEME_PROJECTION = {
  ...
  "color-action-soft-foreground": "color.action.soft-foreground",
  ...
  "color-feedback-success-soft-foreground": "color.feedback.success.soft-foreground",
  ...
  "color-feedback-warning-soft-foreground": "color.feedback.warning.soft-foreground",
  ...
  "color-feedback-danger-soft-foreground": "color.feedback.danger.soft-foreground",
  ...
  "color-feedback-info-soft-foreground": "color.feedback.info.soft-foreground",
...
export const COMPATIBILITY_ALIASES = {
  ...
  border: "color-border-default", input: "color-border-default", ring: "color-focus-ring",
  "surface-page": "color-surface-page", "surface-raised": "color-surface-raised", "surface-subtle": "color-surface-secondary",
  "text-primary": "color-text-primary", "text-secondary": "color-text-secondary", "text-tertiary": "color-text-tertiary",
  "border-subtle": "color-border-default", "action-primary": "color-action-default",
  "feedback-success": "color-feedback-success", "feedback-danger": "color-feedback-danger", "feedback-info": "color-feedback-info",
