...
export default async function DesignSystemPage() {
  ...
  return <main className="ds-ledger" data-design-system-locale={locale}>
    ...
    <Section id="display" title={dictionary.designSystemDisplayHeading} description={dictionary.designSystemDisplayDescription}>
      ...
      <div className="ds-row"><StatusBadge label={dictionary.designSystemSuccess} tone="success" /><StatusBadge label={dictionary.designSystemWarning} tone="warning" /><StatusBadge label={dictionary.designSystemError} tone="danger" /><StatusBadge archived label={dictionary.designSystemArchived} /></div>
    </Section>
