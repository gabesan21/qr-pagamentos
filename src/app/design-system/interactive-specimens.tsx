...
export function DesignSystemInteractiveSpecimens({ dictionary }: Readonly<{ dictionary: Dictionary }>) {
  ...
  return <>
    ...
    <section aria-labelledby="interactions" className="ds-section" data-ds-section="interactions">
      ...
      <SimpleTabs label={dictionary.designSystemTabsLabel} tabs={[{ id: "ready", label: dictionary.designSystemReady, count: 2, content: <p>{dictionary.designSystemTabsReady}</p> }, { id: "review", label: dictionary.designSystemWarning, content: <p>{dictionary.designSystemTabsReview}</p> }, { id: "archived", label: dictionary.designSystemArchived, content: <p>{dictionary.designSystemTabsArchived}</p>, disabled: true }]} />
    </section>
