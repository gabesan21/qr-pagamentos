...
export function adminAccountsDirectoryCopy(dictionary: Dictionary): DataDirectoryCopy {
  return {
    ...
    empty: dictionary.adminUsersDirectoryEmpty,
    emptyDescription: dictionary.adminUsersDirectoryEmptyDescription,
