...
export function adminPaymentLinksDirectoryCopy(dictionary: Dictionary): DataDirectoryCopy {
  return {
    ...
    empty: dictionary.adminPaymentLinkV2DirectoryEmpty,
    emptyDescription: dictionary.adminPaymentLinkV2DirectoryEmptyDescription,
