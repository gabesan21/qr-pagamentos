...
const request = (body = new URLSearchParams(), id = "unused") => new Request(`http://0.0.0.0:3000/admin/catalog/currency-pairs/${id}`, { method: "POST", headers: { origin: "http://0.0.0.0:3000", host: "0.0.0.0:3000" }, body });
