...
export default async function PublicCheckoutPage({ params }: Readonly<{ params: Promise<{ identifier: string }> }>) {
  ...
  // The additive Commerce V2 presentation resolves the checkout view, the
  // 9.3.2 paid terminal view for a consumed single-use link, or the one
  // opaque unavailable view covering every other outcome.
