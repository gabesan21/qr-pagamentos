...
// domain; this drilldown supplies only its own empty copy.
export function linkOrdersDirectoryCopy(dictionary: Dictionary): DataDirectoryCopy {
  return {
    ...
    empty: dictionary.paymentLinkOrdersEmpty,
    emptyDescription: dictionary.paymentLinkOrdersEmptyDescription,
