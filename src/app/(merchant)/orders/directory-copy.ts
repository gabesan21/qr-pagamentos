...
export function ordersDirectoryCopy(dictionary: Dictionary): DataDirectoryCopy {
  return {
    ...
    empty: dictionary.orderV2DirectoryEmpty,
    emptyDescription: dictionary.orderV2DirectoryEmptyDescription,
