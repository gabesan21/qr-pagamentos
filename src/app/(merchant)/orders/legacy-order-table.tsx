...
// The eight V1 states are the same closed vocabulary the owner V2 directory
...
// Owner-local, read-only presentation of the byte-frozen V1 ledger
...
// directory above it instead of a different composition. Mirrors the
// administrator's local legacy table (10.2.1) on the owner scope.
export function MerchantLegacyOrderTable({
  detailHref,
  dictionary,
  locale,
  orders,
