...
- Validate operator-selected callback URLs before provider dispatch; require absolute HTTPS — or HTTP on a loopback host (`localhost`, `127.0.0.1`, `[::1]`) for local testing — without embedded credentials or fragments.
