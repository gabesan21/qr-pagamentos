...
- Scope: sessionless server checkout reservation, replay fencing, and redacted payment-capability issuance.
...
- Keep public outcomes redacted and no-store; UI, polling/status transport, owner views, and explicit recovery belong to separate approved tasks.
