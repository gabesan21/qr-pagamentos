export const adminUserProfileEn = {
  ...
  adminUserProfilePasswordResetConfirmTitle: "Send password reset email",
  adminUserProfilePasswordResetConfirmDescription: "This sends a single-use password reset link to the account's contact email.",
