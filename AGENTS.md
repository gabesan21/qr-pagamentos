...
- `install/` owns Debian/Ubuntu operator install/uninstall procedures; never place passwords in its environment file or make default uninstall remove PostgreSQL data or Docker packages.
