...
> Antes de criar: procure nota existente sobre o mesmo tema (grep em `notes/`) — se existir, **atualize-a** em vez de duplicar. Achado que contradiz nota/decisão anterior é registrado, nunca silenciado:
