...
| 4 | [[roadmap/4-checkout-and-orders|Checkout and order lifecycle]] | Deliver owner-isolated checkout, QR payments, customer-data policy, order lifecycle, and user/admin order views. | pendente |
