...
| 13 | [[roadmap/13-pre-production-hardening|Pre-production hardening]] | Restore webhook HMAC, close release-blocking lifecycle gaps, make deployment docs and gates truthful, validate provider config (planned 2026-09-23). | concluída |
