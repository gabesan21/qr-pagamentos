...
| 15 | [[roadmap/15-v2-only-pix-integrity-and-explicit-checkout|V2-only, PIX integrity and explicit checkout]] | Remove V1 integrally, make PIX data durable and provider errors fail closed, and give the checkout explicit no-retry states (approved 2026-09-22). | em andamento |
