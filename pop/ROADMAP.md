...
|---|-------|-------------|--------|
| 1 | [[roadmap/1-administrative-foundation|Administrative foundation]] | Establish the self-hosted runtime, identity, access control, global settings, and bilingual admin shell. | em andamento |
| 2 | [[roadmap/2-nautt-finance-integration|Nautt Finance integration]] | Onboard API keys with wallet balance, pricing, orders, polling, and central webhook intake. | pendente |
| 3 | [[roadmap/3-catalog-and-payment-links|Catalog and payment links]] | Manage products, currencies, and active single-use or reusable payment links with one currency each. | pendente |
