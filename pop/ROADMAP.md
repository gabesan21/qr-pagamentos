...
| 3 | [[roadmap/3-catalog-and-payment-links|Catalog and payment links]] | Manage administrator-configured Nautt currency/payment-method UUID records, products, and active single-use or reusable payment links with one currency each. | em andamento |
