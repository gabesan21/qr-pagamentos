...
| M-4 | Test baseline determinism | `M-4.1-repair-test-baseline-determinism` repairs the three carried test failures and excludes task worktrees from `pnpm test`. · size: S · yolo: yes | in progress |
