...
- **Status:** aprovada
- **Created:** 2026-07-13
- **Updated:** 2026-07-27 — task 10.3.2 delivered the administrator-global user directory and read-only account detail (global account inspection with derived state, store, and activity facts; deleted accounts stay listed with attribution). Earlier: 2026-07-26 — task 10.2.1 delivered the read-only administrator-global Commerce V2 order directory and detail (administrator order inspection now covers V2 globally, with owner attribution preserved through soft deletion). Earlier: 2026-07-26 — task 10.3.1 delivered terminal administrator-driven user soft deletion (identifiers retained, attribution preserved). Earlier: 2026-07-21 — task 4.1.1 delivered owner isolation and the account checkout-data policy; task 4.3.1 delivered owner order inspection and read-only administrator order inspection. Earlier: 2026-07-26 — task 10.2.2 delivered the read-only administrator-global Commerce V2 payment-link directory and detail (administrator link inspection is V2-only, with owner attribution preserved through soft deletion).
