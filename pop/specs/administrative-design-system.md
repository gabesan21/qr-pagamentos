...
- Lockups use reviewed outlines from pinned licensed IBM Plex Sans bytes, with no live font dependency. Adjacent marks are decorative; standalone marks have one caller-supplied localized name.
