...
- [[1.2.3-implement-database-sessions]] (2026-07-16, authorized toolchain alignment) — project and container pins now use Node.js 26.4.0 and pnpm 11.3.0, with the amd64 Node image fixed to `node:26.4.0-bookworm-slim@sha256:70a832c538c185e6a1a5387d46fc5b615363c50d49dcf50505879ee3f39c6001`. Session implementation remains pending.
