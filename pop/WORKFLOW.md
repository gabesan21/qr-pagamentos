...
- **Três classes de arquivo, três rotas — e só uma delas é o kanban.** A classe decide como se conserta; nenhuma delas se decide por rótulo de card:
  ...
  3. **Conteúdo** (código, manuscrito, o trabalho real): **só** por task que chegou legitimamente a `004_processing`. É esta classe — e nenhuma outra — que a regra 13 protege.
