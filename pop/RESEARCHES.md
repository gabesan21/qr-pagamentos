...
- **Status:** on-hold-by-beta-decision (M-5.1, human decision 2026-07-25) — the research is still required and will resume once the M-5.1 reversal is approved (see [[open_questions/2026-07-25-pre-production-gate-restore-webhook-hmac]]).
