...
| Task | Description (≤1 line) | Status |
|------|----------------------|--------|
| [[4.2.1-public-checkout-orchestration]] | Create orders from active owner-bound links and generate Nautt QR payments without exposing trusted inputs. · size: L | 001_initial_task |
