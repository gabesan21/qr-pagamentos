...
| `12.5.4-remodel-merchant-catalog` | Match product/category directories, forms, localized content, media staging, lifecycle confirmations, and archived facts under `src/app/(merchant)/catalog/**`. · size: L | 001_initial_task |
