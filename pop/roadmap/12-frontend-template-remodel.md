...
| [[12.6.2-remodel-public-storefront-and-cart]] | Extrapolate the template faithfully across `/store/[slug]`, its boxed/table catalog, custom amount, cart, reconciliation, branding, and all loading/empty/error states. · size: L | 001_initial_task |
