...
| `12.3.3-phase-verification` | Author/run the phase suite (accumulated `verify: phase` criteria) via direct pnpm and repair what it catches; depends on all 12.3 tasks. · size: M | não iniciada |
