...
| Task | Description | Status |
|------|-------------|--------|
| [[14.4.1-converge-shell-and-auth-pages]] | Route title, `lg` rail breakpoint, monogram footer, storefront link, auth brand panel on the left with tagline/swatches, forgot-password, show/hide, 6-cell TOTP, distinct reset states, bilingual 404. · size: L | 004_processing |
